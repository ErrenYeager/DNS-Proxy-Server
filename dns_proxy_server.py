...
class DNSProxyServer:
    ...
    def start_dns_proxy(self):
        ...
        while True:
            ...
            transaction_id, request_domains, query_type = self.parser.parse_dns_packet(data)
            ...
            response_data = self.construct_dns_response(transaction_id, data[12:], query_type, ip)
    ...
    def construct_dns_response(self, transaction_id, queries, query_type, ip):
        ...
        response_packet += self.create_answer_section(query_type, ip)

        return response_packet

    def create_answer_section(self, query_type, answer):
        if answer is None:
        ...
        answer_section += b'\x00\x01' if query_type == "A" else b'\x00\x1c'  # Type: A (IPv4 address)
